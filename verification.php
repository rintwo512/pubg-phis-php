...
<div class="season-alert-title">Complete your account detail first</div>
</div> <!--- season-alert --->
<div class="box">
...
<input type="text" name="nick" id="nick" placeholder="Enter your character name" autocomplete="off" required>
...
<option selected="selected" disabled="disabled" value="">Choose your ranked tier level</option>
...
<option selected="selected" disabled="disabled" value="">Choose your royale pass type</option>
...
<option selected="selected" disabled="disabled" value="">Choose your royale pass level</option>
<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<option selected="selected" disabled="disabled" value="">Choose your platform</option>
